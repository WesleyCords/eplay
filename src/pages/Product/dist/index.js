...
var Product = function () {
    ...
    var _a = api_1.useGetGameQuery(id), gameToId = _a.data, isLoading = _a.isLoading;
    if (isLoading) {
        return React.createElement("h3", null,
            "Carregando jogo com ID ",
            id,
            "...");
    }
    if (gameToId) {
        return (React.createElement(React.Fragment, null,
            ...
            React.createElement(Section_1["default"], { title: "Sobre o jogo", background: "black" },
                React.createElement("p", null, gameToId.description)),
            React.createElement(Section_1["default"], { title: "Mais detalhes", background: "gray" },
            ...
            React.createElement(Gallery_1["default"], { items: gameToId.media.gallery, defaultCover: gameToId.media.cover, name: gameToId.name })));
    }
    return React.createElement(styles_1.ErrorOrLoading, null, "Jogo n\u00E3o encontrado.");
};
